...
func (iostat *IOSTAT) run() ([]string, map[string]float64, error) {
	/////////////////////////////////////////////////////////////////////////////////////////
	...
	args := []string{"-c", "-d", "-p", "-g", "ALL", "-x", "-k"}

	reader, err := iostat.cmd.Run("iostat", args)
	if err != nil {
		return nil, nil, err
	}
